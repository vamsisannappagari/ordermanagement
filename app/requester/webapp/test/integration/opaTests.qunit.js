...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "requester/test/integration/FirstJourney",
    "requester/test/integration/PurchaseRequisitionsListJourney",
    "requester/test/integration/PurchaseRequisitionsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
